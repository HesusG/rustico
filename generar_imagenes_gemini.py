...
PROMPTS_ORIGINALES = {
    "01_libreta_gastos": (
        "A top-down photograph of an open hard-cover lined notebook (libreta de pasta dura rayada) "
        "resting on a rustic dark wooden table with visible wood grain. The notebook has yellowed pages "
        "from use. A blue BIC ballpoint pen with cap rests on the right page. There is a circular brown "
        "coffee ring stain on the right page. "
        "On the LEFT page, handwritten expense entries in Spanish with blue pen, informal cursive but "
        "legible. At the top right corner of the page: 'Febrero 2026'. Below the header: "
        "'Rustico Pizza y Pan' and 'Morelia, Michoacán'. "
        "The entries in DD/MM format: "
        "\"03/02  Gas LP — $380\", "
        "\"05/02  Harina (2 bultos) — $790\", "
        "\"06/02  Queso Oaxaca 5kg — $650\", "
        "\"09/02  Servilletas y desechables — $145\", "
        "\"11/02  Jitomate caja — $230\", "
        "\"13/02  Aceite de oliva — $310\", "
        "\"16/02  Huevo cartón — $95\", "
        "\"16/02  Huevo cartón — $110\", "
        "\"18/02  Verdura variada — $150\", "
        "\"18/02  Verdura surtida — $165\". "
        "CRITICAL: The header MUST say 'Febrero 2026' in Spanish, NEVER 'October' or 'February'. "
        "ALL text must be in Spanish. Warm natural side lighting."
    ),
    "02_corte_caja": (
        "A photograph at 30-degree angle of a single sheet of grid paper (hoja cuadriculada, letter "
        "size) on a stainless steel countertop. The sheet is slightly wrinkled with a folded corner. "
        "A black basic Casio calculator is partially visible in the upper right corner. "
        "Handwritten text in blue and red pen. At the top: "
        "\"Corte de Caja          Miércoles 18/Feb/2026\" "
        "Below, a hand-drawn table with ruler (straight but imperfect lines): "
        "Columns: Concepto | Entrada | Salida | Saldo. "
        "Rows: \"Fondo inicial — — — $2,000\", "
        "\"Ventas mostrador — $4,850 — — —\", "
        "\"Pago repartidor — — $350 — —\", "
        "\"Compra refrescos — — $480 — —\", "
        "\"Ventas Rappi — $1,200 — — —\", "
        "\"TOTAL — $8,050 — $830 — $7,220\". "
        "The TOTAL row is in RED pen. The final saldo '$7,220' is circled in red with a '?' next to it. "
        "In the right margin, arithmetic scribbled: $2,000 + $4,850 + $1,200 - $350 - $480 = $7,220. "
        "CRITICAL: The date MUST read '18/Feb/2026' — NEVER October. ALL text in Spanish."
    ),
    "03_notas_proveedor": (
