...
Para 2025, el negocio acumula una calificación de **4.9 sobre 5** con más de **159 reseñas** en Google, posicionándose como una de las pizzerías mejor valoradas de toda Morelia. El perfil de reseñas refleja una lealtad poco común: más del **92% son de cinco estrellas**, con comentarios que van desde "la pizza más rica que he probado en Morelia" hasta "el tiramisú de Mariana es un pecado" y "Martín siempre te recibe con una sonrisa". Esa cercanía, esa sensación de que no estás comprando en un negocio sino visitando a alguien que cocina para ti con cariño, es lo que hace de Rústico algo más que una pizzería.
...
Rústico Pizza y Pan opera con una **estructura organizacional simple (lineal)**, característica de las microempresas familiares del sector restaurantero mexicano, donde el 96% de los establecimientos tiene 10 empleados o menos. La toma de decisiones es centralizada en Martín y Mariana como fundadores y propietarios, y la comunicación interna es directa, verbal e informal. No existen manuales de procedimientos formalizados ni jerarquías intermedias.
...
```mermaid
graph TD
    A["<b>Propietario / Director General</b><br/>Administración, estrategia,<br/>compras y finanzas"]

    B["<b>Jefe de Cocina /<br/>Pizzero Principal</b><br/>Producción de pizzas,<br/>control de calidad"]

    C["<b>Panadero / Repostero</b><br/>Pan, postres y<br/>productos de temporada"]

    D["<b>Ayudante de Cocina</b><br/>Preparación, limpieza<br/>y apoyo operativo"]

    E["<b>Atención al Cliente / Caja</b><br/>Ventas, cobro,<br/>empaque y redes sociales"]
...
#### Propietario / Director General: Martín Valadés Cendejas

| Aspecto | Detalle |
|---|---|
| **Nombre** | Martín Valadés Cendejas |
...
| **Participación operativa** | Alta. Martín trabaja directamente en cocina la mayor parte del turno, alternando con la atención al cliente y las compras matutinas de insumos |

#### Jefe de Cocina / Pizzero Principal: Martín Valadés Cendejas (doble rol)

| Aspecto | Detalle |
|---|---|
| **Nombre** | Martín Valadés Cendejas (mismo propietario) |
...
| **Responsabilidades clave** | Mantener la estación de trabajo limpia y organizada, seguir instrucciones de Martín en cocina, apoyar en el empaque de pedidos |
| **Perfil** | Estudiante de gastronomía en el CONALEP Morelia. Trabaja medio tiempo en Rústico desde 2022. Ha aprendido las técnicas de masa y horneado directamente de Martín y aspira a abrir su propio negocio de comida en el futuro |

#### Atención al Cliente / Caja: Sofía Valadés Cendejas

| Aspecto | Detalle |
|---|---|
| **Nombre** | Sofía Valadés Cendejas |
